---
name: "source-command-deploy-vps-akamai-cc"
description: "Deploy the latest OmniRoute code to the Akamai VPS (69.164.221.35)"
---

# source-command-deploy-vps-akamai-cc

Use this skill when the user asks to run the migrated source command `deploy-vps-akamai-cc`.
