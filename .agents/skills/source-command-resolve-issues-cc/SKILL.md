---
name: "source-command-resolve-issues-cc"
...
# source-command-resolve-issues-cc

Use this skill when the user asks to run the migrated source command `resolve-issues-cc`.
