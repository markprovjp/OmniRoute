---
name: "source-command-generate-release-cc"
description: "Create a new release, bump version up to the .10 patch threshold, update changelog, and manage Pull Requests"
---

# source-command-generate-release-cc

Use this skill when the user asks to run the migrated source command `generate-release-cc`.
