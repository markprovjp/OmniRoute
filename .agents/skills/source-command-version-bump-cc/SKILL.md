---
name: "source-command-version-bump-cc"
...
# source-command-version-bump-cc

Use this skill when the user asks to run the migrated source command `version-bump-cc`.
...
- This workflow does **NOT** update `docs/i18n/` translations. Translation updates are handled manually or via release tooling — the `/update-i18n` command does not currently exist as a Codex slash command.
