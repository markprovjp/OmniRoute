---
name: "source-command-deploy-vps-both-cc"
description: "Deploy the latest OmniRoute code to BOTH the Akamai VPS and the Local VPS"
---

# source-command-deploy-vps-both-cc

Use this skill when the user asks to run the migrated source command `deploy-vps-both-cc`.
