---
name: "source-command-deploy-vps-local-cc"
description: "Deploy the latest OmniRoute code to the Local VPS (192.168.0.15)"
---

# source-command-deploy-vps-local-cc

Use this skill when the user asks to run the migrated source command `deploy-vps-local-cc`.
