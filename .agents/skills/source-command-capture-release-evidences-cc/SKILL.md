---
name: "source-command-capture-release-evidences-cc"
...
# source-command-capture-release-evidences-cc

Use this skill when the user asks to run the migrated source command `capture-release-evidences-cc`.
